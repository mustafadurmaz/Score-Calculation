...
namespace WebApplication8.Controllers
{
    ...
    public class OssLisansController : ControllerBase
    {

        PuanHesaplamaContext db = new PuanHesaplamaContext();
        private readonly _2023OsymLisans osymLisans;

        [HttpGet]
        public ActionResult<IEnumerable<object>> GetAllList()
        {
            var ossDataSet = from o in db._2023OsymLisans
                             where o.Aktif == 1
                             select new
                             {
        ...
        [HttpPost]
        public ActionResult<IEnumerable<object>>  GetFilterOssList([FromBody] OSSLisans dtOss)
        {
            if (dtOss.tabanPuan == 0 && dtOss.tavanPuan > 0)
            {
                var ossList = from o in db._2023OsymLisans
